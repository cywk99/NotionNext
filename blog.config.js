...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || "Hi，I'm a Software Engineer, Hi，I'm a Tech Enthusiast, Welcome to my blog 🎉",

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Christopher Yong', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Software Engineer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://github.com/cywk99', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || "Christopher's Blog", // 网站关键词 英文逗号隔开
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    {
      url: 'https://music.163.com/song/media/outer/url?id=34218478'
    }
  ],
